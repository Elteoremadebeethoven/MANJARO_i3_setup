...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  hi Typesss guifg = #00D8FF guibg=NONE guisp=NONE gui=bold ctermfg=30 ctermbg=NONE cterm=bold
  hi ClassPa guifg = #2AE700 cterm=italic gui=italic
...
hi Typess guifg = #ffaf00 guibg=NONE guisp=NONE gui=bold ctermfg=30 ctermbg=NONE cterm=bold


hi link pythonThis Typess
