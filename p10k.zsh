# Generated by Powerlevel10k configuration wizard on 2021-03-14 at 00:19 CST.
...
# 12h time, 2 lines, solid, no frame, blue-ornaments, sparse, many icons, concise,
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      if [[ -n $VCS_STATUS_TAG ]]; then
        ...
        res+=" ${clean}${(g::)POWERLEVEL9K_VCS_TAG_ICON}" # here
